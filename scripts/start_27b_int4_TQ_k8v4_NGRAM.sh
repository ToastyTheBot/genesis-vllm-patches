...
docker run -d \
  ...
  -e GENESIS_ENABLE_PR40941_TQ_WORKSPACE_REVERT=1 -e GENESIS_ENABLE_PR40941B_WORKSPACE_GET_SIMULTANEOUS_MEMO=1 \
  -e GENESIS_ENABLE_P67_TQ_MULTI_QUERY_KERNEL=1 -e GENESIS_ENABLE_PR41123_TQ_CONTINUATION_64TOK_SLICE=1 -e GENESIS_ENABLE_PR41127_FLASHINFER_FULL_CUDAGRAPH=1 \
  ...
  -e GENESIS_ENABLE_PR41411_PROMPT_LOGPROBS_EVICTION=0 \
  -e GENESIS_ENABLE_PN54_GDN_CONTIGUOUS_DEDUP=0 \
  -e GENESIS_ENABLE_PR41602_WAKE_UP_HYBRID_KV=0 \
  \
  -e GENESIS_ENABLE_PR41418B_TQ_CENTROIDS_DISK_CACHE=0 \
  -e GENESIS_ENABLE_PR40962_SPEC_REASONING_BOUNDARY=0 \
  -e GENESIS_ENABLE_PN59_STREAMING_GDN=0 \
  -e GENESIS_ENABLE_PR41467_MTP_TRUNCATION_DETECTOR=0 \
