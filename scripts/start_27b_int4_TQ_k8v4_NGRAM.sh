...
docker run -d \
  ...
  -e GENESIS_ENABLE_PR40941=1 -e GENESIS_ENABLE_PR40941B=1 \
  -e GENESIS_ENABLE_P67_TQ_MULTI_QUERY_KERNEL=1 -e GENESIS_ENABLE_PR41123=1 -e GENESIS_ENABLE_PR41127=1 \
