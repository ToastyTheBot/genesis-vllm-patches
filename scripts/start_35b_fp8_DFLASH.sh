...
docker run -d \
  ...
  -e GENESIS_ENABLE_P74_CHUNK_CLAMP=1 -e GENESIS_ENABLE_PR40610_ASYNC_PROPOSER_SYNC=0 -e GENESIS_ENABLE_PR37629_STALE_SPEC_TOKEN_CLEANUP=0 -e GENESIS_ENABLE_PR40925_FP8_BLOCK_SCALED_M_LE_8=1 -e GENESIS_ENABLE_P82=1 -e GENESIS_ENABLE_PR40849_MTP_DRAFT_ONLINE_QUANT=1 -e GENESIS_ENABLE_PR41142_GDN_AB_CONTIGUOUS=1 -e GENESIS_ENABLE_PR40941B_WORKSPACE_GET_SIMULTANEOUS_MEMO=1 -e GENESIS_ENABLE_PN17_FA2_LSE_CLAMP=1 -e GENESIS_ENABLE_PR41268_SCOPED_MAX_SPLIT=1 -e GENESIS_ENABLE_PR39419_LOCAL_ARGMAX_TP=1 -e GENESIS_ENABLE_PR40727_DFLASH_AUX_LAYER_FIX=1 -e GENESIS_ENABLE_PR39148_MERGE_ATTN_NAN_GUARD=0 -e GENESIS_ENABLE_P103=1 -e GENESIS_ENABLE_PR41123_TQ_CONTINUATION_64TOK_SLICE=1 -e GENESIS_P82_THRESHOLD_SINGLE=0.3 -e GENESIS_ENABLE_P78_TOLIST_CAPTURE_GUARD=1 -e GENESIS_ENABLE_PN40_DFLASH_OMNIBUS=1 -e GENESIS_ENABLE_PN51_QWEN3_STREAMING_THINKING_DISABLED=0 -e GENESIS_ENABLE_PR41411_PROMPT_LOGPROBS_EVICTION=0 -e GENESIS_ENABLE_PR41602_WAKE_UP_HYBRID_KV=0 -e GENESIS_ENABLE_PR41418B_TQ_CENTROIDS_DISK_CACHE=0 -e GENESIS_ENABLE_PR40962_SPEC_REASONING_BOUNDARY=0 -e GENESIS_ENABLE_PR41467_MTP_TRUNCATION_DETECTOR=0 -e GENESIS_PREALLOC_TOKEN_BUDGET=4096 -e GENESIS_BUFFER_MODE=shared \
