...
docker run -d \
  ...
  -e GENESIS_ENABLE_PR41422_SPARSE_V=0 -e GENESIS_ENABLE_PN25_SILU_INDUCTOR_SAFE=1 \
  -e GENESIS_ENABLE_P38B_COMPILE_SAFE=1 -e GENESIS_ENABLE_P15B_FA_VARLEN_CLAMP=1 -e GENESIS_ENABLE_PR39148_MERGE_ATTN_NAN_GUARD=1 \
  -e GENESIS_ENABLE_P67_TQ_MULTI_QUERY_KERNEL=1 -e GENESIS_ENABLE_PR41123_TQ_CONTINUATION_64TOK_SLICE=1 -e GENESIS_ENABLE_PR41127_FLASHINFER_FULL_CUDAGRAPH=1 -e GENESIS_ENABLE_PR40385_MARLIN_TP_CUDAGRAPH_CAP=1 \
  ...
  -e GENESIS_ENABLE_PR41043_SPEC_PREPARE_NEXT_IDS_ZERO_ALLOC=1 \
  ...
  -e GENESIS_ENABLE_PR41411_PROMPT_LOGPROBS_EVICTION=1 \
  -e GENESIS_ENABLE_PN54_GDN_CONTIGUOUS_DEDUP=0 \
  -e GENESIS_ENABLE_PR41602_WAKE_UP_HYBRID_KV=1 \
  \
  -e GENESIS_ENABLE_PR41418B_TQ_CENTROIDS_DISK_CACHE=1 \
  -e GENESIS_ENABLE_PR40962_SPEC_REASONING_BOUNDARY=0 \
  -e GENESIS_ENABLE_PN59_STREAMING_GDN=1 \
  -e GENESIS_ENABLE_PR41467_MTP_TRUNCATION_DETECTOR=1 -e GENESIS_ENABLE_PN65=1 \
  -e GENESIS_ENABLE_PR41268_SCOPED_MAX_SPLIT=1 -e GENESIS_ENABLE_PR39419_LOCAL_ARGMAX_TP=1 -e GENESIS_ENABLE_P103=1 \
