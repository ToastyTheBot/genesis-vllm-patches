...
docker run -d \
  ...
  -e GENESIS_ENABLE_PR41422=0 -e GENESIS_ENABLE_PN25_SILU_INDUCTOR_SAFE=1 \
  -e GENESIS_ENABLE_P38B_COMPILE_SAFE=1 -e GENESIS_ENABLE_P15B_FA_VARLEN_CLAMP=1 -e GENESIS_ENABLE_PR39148=1 \
  ...
  -e GENESIS_ENABLE_PR41411=1 \
  -e GENESIS_ENABLE_PN54_GDN_CONTIGUOUS_DEDUP=0 \
  -e GENESIS_ENABLE_PR41602=1 \
  \
  -e GENESIS_ENABLE_PR41418B=1 \
  -e GENESIS_ENABLE_PR40962=0 \
  -e GENESIS_ENABLE_PN59_STREAMING_GDN=1 \
  -e GENESIS_ENABLE_PR41467=1 -e GENESIS_ENABLE_PN65=1 \
  -e GENESIS_ENABLE_PR41268=1 -e GENESIS_ENABLE_PR39419=1 -e GENESIS_ENABLE_P103=1 \
