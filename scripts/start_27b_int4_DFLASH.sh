...
docker run -d \
  ...
  -e GENESIS_ENABLE_PR40941B_WORKSPACE_GET_SIMULTANEOUS_MEMO=1 \
  \
  ...
  -e GENESIS_ENABLE_PR41268_SCOPED_MAX_SPLIT=1 \
  -e GENESIS_ENABLE_P103=1 \
  \
  -e GENESIS_ENABLE_PR40727_DFLASH_AUX_LAYER_FIX=1 \
  -e GENESIS_ENABLE_PR39419_LOCAL_ARGMAX_TP=1 \
