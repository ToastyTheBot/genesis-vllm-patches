...
docker run -d \
  ...
  -e GENESIS_ENABLE_P74_CHUNK_CLAMP=1 -e GENESIS_ENABLE_PR40610_ASYNC_PROPOSER_SYNC=0 -e GENESIS_ENABLE_PR37629_STALE_SPEC_TOKEN_CLEANUP=0 -e GENESIS_ENABLE_PR40925_FP8_BLOCK_SCALED_M_LE_8=1 -e GENESIS_ENABLE_P82=1 -e GENESIS_ENABLE_PR40849_MTP_DRAFT_ONLINE_QUANT=1 -e GENESIS_ENABLE_PR41142_GDN_AB_CONTIGUOUS=1 -e GENESIS_ENABLE_PR40941B=1 -e GENESIS_ENABLE_PR41123=1 -e GENESIS_P82_THRESHOLD_SINGLE=0.3 -e GENESIS_PREALLOC_TOKEN_BUDGET=4096 -e GENESIS_BUFFER_MODE=shared \
