...
docker run -d \
  ...
  -e GENESIS_ENABLE_P74_CHUNK_CLAMP=1 -e GENESIS_ENABLE_PR40610=0 -e GENESIS_ENABLE_PR37629=0 -e GENESIS_ENABLE_PR40925=1 -e GENESIS_ENABLE_P82=1 -e GENESIS_ENABLE_P40=1 -e GENESIS_ENABLE_PR40941B=1 -e GENESIS_ENABLE_PR41123=1 -e GENESIS_P82_THRESHOLD_SINGLE=0.3 -e GENESIS_PREALLOC_TOKEN_BUDGET=4096 -e GENESIS_BUFFER_MODE=shared \
