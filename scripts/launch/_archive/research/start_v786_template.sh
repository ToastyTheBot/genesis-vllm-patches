...
#
# Phase 3 (INT8 27B sprint resume with PR40849 + PR39930):
#   Use v788 INT8 launch scripts; add PR40849/PR39930 env vars there.
#
...
docker run -d \
  ...
  -e GENESIS_ENABLE_PR40610=0 -e GENESIS_ENABLE_PR37629=0 \
  \
  -e GENESIS_ENABLE_PR40925=1 -e GENESIS_ENABLE_P82=1 \
  -e GENESIS_ENABLE_PR40941B=1 -e GENESIS_ENABLE_PR41123=1 \
