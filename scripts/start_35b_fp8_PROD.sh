...
docker run -d \
  ...
  -e GENESIS_ENABLE_P74_CHUNK_CLAMP=1 -e GENESIS_ENABLE_PR40610=0 -e GENESIS_ENABLE_PR37629=0 -e GENESIS_ENABLE_PR40925=1 -e GENESIS_ENABLE_P82=1 -e GENESIS_ENABLE_PR40849=1 -e GENESIS_ENABLE_PR41142=1 -e GENESIS_ENABLE_PR40941B=1 -e GENESIS_ENABLE_PN17_FA2_LSE_CLAMP=1 -e GENESIS_ENABLE_PR41268=1 -e GENESIS_ENABLE_PR39419=1 -e GENESIS_ENABLE_PR41422=0 -e GENESIS_ENABLE_PR34207=1 -e GENESIS_ENABLE_PR40074=1 -e GENESIS_ENABLE_P103=1 -e GENESIS_ENABLE_PR41123=1 -e GENESIS_P82_THRESHOLD_SINGLE=0.3 -e GENESIS_ENABLE_P78_TOLIST_CAPTURE_GUARD=1 -e GENESIS_ENABLE_PN40_DFLASH_OMNIBUS=1 -e GENESIS_ENABLE_PN51_QWEN3_STREAMING_THINKING_DISABLED=1 -e GENESIS_ENABLE_PR41411=1 -e GENESIS_ENABLE_PR41602=1 -e GENESIS_ENABLE_PR41418B=1 -e GENESIS_ENABLE_PR40962=0 -e GENESIS_ENABLE_PR41467=1 -e GENESIS_ENABLE_P38B_COMPILE_SAFE=1 -e GENESIS_ENABLE_P15B_FA_VARLEN_CLAMP=1 -e GENESIS_ENABLE_P102=1 -e GENESIS_ENABLE_PN65=1 -e GENESIS_PREALLOC_TOKEN_BUDGET=4096 -e GENESIS_BUFFER_MODE=shared \
