...
_register(Preset(
    ...
    description=(
        ...
        "calling: P61 multi-tool / PR36138 reasoning grammar / P68/P69 "
...
_register(Preset(
    ...
    genesis_env={
        ...
        "GENESIS_PR41418_SPARSE_V_BLOCK_KV": "8",
        "GENESIS_PR41418_SPARSE_V_NUM_WARPS": "4",
        "GENESIS_PR41418_SPARSE_V_THRESHOLD": "0.01",
    },
    system_env={
        "VLLM_WORKER_MULTIPROC_METHOD": "spawn",
        "VLLM_USE_FLASHINFER_SAMPLER": "1",
    ...
    notes=[
        "ℹ PR41422 sparse-V kernel tuned for 27B BLOCK_KV=8 — works "
        "well on 35B too.",
    ],
))
...
_register(Preset(
    ...
    notes=[
        "ℹ 8 ranks × 16GB — careful with PR34207 pool sizing on small per-rank VRAM.",
    ],
))
