...
"""Wiring for PR41418b — TurboQuant centroids disk-persistent cache.
...
GENESIS_PR41418b_MARKER = "Genesis PR41418b TQ centroids disk cache (vllm#41418 inspiration)"
...
ANCHOR_NEW = (
    "# [Genesis PR41418b vllm#41418-inspired] disk-persistent cache for centroids.\n"
    ...
    "_GENESIS_PR41418b_CACHE_PATH = None  # lazily resolved on first use\n"
    "_GENESIS_PR41418b_DISK = None  # lazily loaded\n"
    "\n"
    "def _genesis_pn57_path():\n"
    "    import os as _os  # LOCAL — no top-level dependency\n"
    "    global _GENESIS_PR41418b_CACHE_PATH\n"
    "    if _GENESIS_PR41418b_CACHE_PATH is None:\n"
    "        _GENESIS_PR41418b_CACHE_PATH = _os.path.expanduser(\n"
    "            \"~/.cache/genesis/turboquant_centroids.pkl\"\n"
    "        )\n"
    "    return _GENESIS_PR41418b_CACHE_PATH\n"
    "\n"
    "def _genesis_pn57_load_disk():\n"
    "    import os as _os  # LOCAL\n"
    "    global _GENESIS_PR41418b_DISK\n"
    "    if _GENESIS_PR41418b_DISK is not None:\n"
    "        return _GENESIS_PR41418b_DISK\n"
    "    try:\n"
    "        import pickle\n"
    "        _path = _genesis_pn57_path()\n"
    "        if _os.path.isfile(_path):\n"
    "            with open(_path, \"rb\") as _f:\n"
    "                _GENESIS_PR41418b_DISK = pickle.load(_f)\n"
    "        else:\n"
    "            _GENESIS_PR41418b_DISK = {}\n"
    "    except Exception:\n"
    "        _GENESIS_PR41418b_DISK = {}\n"
    "    return _GENESIS_PR41418b_DISK\n"
    "\n"
    ...
    "            pickle.dump(_GENESIS_PR41418b_DISK, _tf)\n"
    "            _tmp = _tf.name\n"
...
def _make_patcher() -> TextPatcher | None:
    ...
    if target is None:
        return None
    return TextPatcher(
        patch_name="PR41418b TQ centroids disk cache (vllm#41418 inspiration)",
        target_file=str(target),
        marker=GENESIS_PR41418b_MARKER,
...
def apply() -> tuple[str, str]:
    ...
    decision, reason = should_apply("PR41418b")
    log_decision("PR41418b", decision, reason)
    if not decision:
    ...
    if result == TextPatchResult.APPLIED:
        return "applied", "PR41418b applied: TQ centroids disk-cached"
