...
"""Wiring for PR41602 — vllm#41602 backport.
...
GENESIS_PR41602_MARKER = "Genesis PR41602 wake_up hybrid KV (vllm#41602)"
...
ANCHOR_NEW = (
    "        kv_caches = getattr(self, \"kv_caches\", [])\n"
    "        # [Genesis PR41602 vllm#41602] Hybrid models (Mamba, DeltaNet)\n"
...
def _make_patcher() -> TextPatcher | None:
    ...
    if target is None:
        return None
    return TextPatcher(
        patch_name="PR41602 wake_up hybrid KV (vllm#41602)",
        target_file=str(target),
        marker=GENESIS_PR41602_MARKER,
...
def apply() -> tuple[str, str]:
    ...
    decision, reason = should_apply("PR41602")
    log_decision("PR41602", decision, reason)
    if not decision:
    ...
    if result == TextPatchResult.APPLIED:
        return "applied", "PR41602 applied: wake_up no longer crashes on hybrid"
