...
PR40768 (#40768 backport) was empirically disproven 2026-04-25.
================================================================
...
block is nested before it, P12's branch doesn't help. PR39055 is additive:
...
- Composes cleanly with P12 (Qwen3 tool_call reasoning fix v2): P12 handles
  the `</think>`-absent case via `<tool_call>` implicit-end; PR39055 handles
...
GENESIS_PR39055_MARKER = "Genesis PR39055 Qwen3 reasoning embedded tool_call recovery v7.13"
...
IMPORT_NEW = (
    "import re  # [Genesis PR39055 vllm#39055]\n"
    "from collections.abc import Sequence\n"
    "from typing import TYPE_CHECKING"
)
...
REGEX_NEW = (
    ...
    "\n"
    "\n"
    "# [Genesis PR39055 vllm#39055] regex for extracting nested tool_call blocks.\n"
...
METHOD_NEW = (
    ...
    "        content,\n"
    "    ):\n"
    "        \"\"\"[Genesis PR39055 vllm#39055] Promote tool_call XML out of reasoning.\n"
    "\n"
...
RETURN_THINK_MONOLITH_NEW = (
    ...
    "        if self.end_token in model_output:\n"
    "            reasoning, _, content = model_output.partition(self.end_token)\n"
    "            # [Genesis PR39055 vllm#39055] extract nested tool_call from reasoning\n"
...
RETURN_TRUNC_NEW = (
    "        # Thinking enabled but no </think>: output was truncated.\n"
    "        # Everything generated so far is reasoning.\n"
    "        # [Genesis PR39055 vllm#39055] still try to extract embedded tool_call\n"
...
def _make_patcher() -> TextPatcher | None:
    ...
    if target is None:
        return None
    return TextPatcher(
        patch_name="PR39055 Qwen3 reasoning embedded tool_call recovery",
        target_file=str(target),
        marker=GENESIS_PR39055_MARKER,
        sub_patches=[
            TextPatch(
                name="p59_import_re",
                anchor=IMPORT_OLD,
...
def apply() -> tuple[str, str]:
    """Apply PR39055 wiring (5 sub-patches in one file). Never raises.
    ...
    decision, reason = should_apply("PR39055")
    log_decision("PR39055", decision, reason)
    if not decision:
    ...
    if result == TextPatchResult.APPLIED:
        return (
            "applied",
            "PR39055 backport applied: 5 sub-patches in qwen3_reasoning_parser.py. "
